...
_$GithubRepoDTOListImpl _$$GithubRepoDTOListImplFromJson(
        Map<String, dynamic> json) =>
    _$GithubRepoDTOListImpl(
      githubRepoDTOList: (json['githubRepoDTOList'] as List<dynamic>)
          .map((e) => GithubRepoDTO.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$$GithubRepoDTOListImplToJson(
        _$GithubRepoDTOListImpl instance) =>
    <String, dynamic>{
      'githubRepoDTOList': instance.githubRepoDTOList,
    };
